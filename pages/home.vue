            ...
            <div class="flex flex-col w-full h-auto mb-4 px-4 pt-3">
                ...
                <div class="flex flex-col w-full h-auto">
                    ...
                    <div class="flex w-full h-8">
                        <NuxtLink class="tracking-wider text-xs font-normal mr-2" to="/focus">关注 {{ followCount }}</NuxtLink>
                        <NuxtLink class=" tracking-wider text-xs font-normal ml-2" :to="{ name: 'fans-id', params: { id: userInfo?.id } }">
                            粉丝 {{ fansCount }}
                        </NuxtLink>
                    </div>
                </div>
