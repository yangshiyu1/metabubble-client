<template>
    <div class="flex bg-base-300 flex-col w-full h-max px-8 min-h-screen pb-20">
        <div class="w-full tracking-widest font-bold  h-16 flex justify-start items-center"><span>标题</span></div>
        <!-- 头部信息 -->
        <div class="flex flex-row pb-1 pt-3">
            ...
            <div class=" ml-5 flex flex-1 flex-col">
                <span style="color: #6c84bb;" class=" font-thin tracking-wide flex text-base ">{{ post.username }}</span>
