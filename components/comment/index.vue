            ...
            <div class="  flex flex-col flex-1">
                ...
                <div class="flex w-auto h-6 pt-4 mb-2  justify-between">
                    ...
                    <div>
                        ...
                        <span style="color: #000;font-weight: 1000;" class=" tracking-wide me-3" v-else>{{ comment.username
                        }}</span>
                ...
                <div class="w-full justify-between flex">
                    <div class="flex pt-2 text-left  flex-1 ">
                        <p style="color: #3c455a;" class=" whitespace-pre-wrap tracking-wider max-h-36 truncate break-all">
                            {{ comment.content }}
                        </p>
                    </div>
                ...
                <div class="info h-10 flex flex-nowrap w-full justify-end items-center">
                    ...
                    <span style="color: #b1b5bf;line-height:2.5rem;" class=" ml-2 h-full text-base mr-4 tracking-wide">{{
                        comment.createTime
                    }}</span>
